...
<link href="support_reg.css" rel="stylesheet">
</head>
<body>
<div id="container">
<div id="wb_Shape2" style="position:absolute;left:250px;top:312px;width:1300px;height:842px;z-index:0;">
<img src="images/img0008.png" id="Shape2" alt="" width="1300" height="842" style="width:1300px;height:842px;"></div>
<div id="wb_ResponsiveMenu1" style="position:absolute;left:250px;top:195px;width:1300px;height:117px;z-index:1;">
...
<div id="wb_Text2" style="position:absolute;left:1124px;top:227px;width:229px;height:21px;text-align:right;z-index:2;">
<span style="color:#800080;font-family:Arial;font-size:19px;"><strong><em>Howdy, $ADMIN</em></strong></span></div>
<div id="wb_Image2" style="position:absolute;left:1394px;top:205px;width:64px;height:64px;z-index:3;">
<img src="images/avatar4-sm.jpg" id="Image2" alt="" width="64" height="64"></div>
<div id="wb_Text4" style="position:absolute;left:730px;top:42px;width:529px;height:77px;text-align:center;z-index:4;">
...
<div id="wb_Image3" style="position:absolute;left:597px;top:17px;width:133px;height:125px;z-index:5;">
<img src="images/logo.png" id="Image3" alt="" width="133" height="125"></div>
<div id="wb_Text3" style="position:absolute;left:745px;top:362px;width:310px;height:36px;text-align:center;z-index:6;">
